...
<form method="post" action="home.php?fd=salvar&pg=produto" style="padding: 50px;">
        ...
        <div class="row">
            <div class="form-group col-4">
                ...
                <input type="text" name="precoCompra" class="form-control" onKeyPress="return(moeda(this,'.',',',event))" placeholder="Digite o Preço de Compra" value="<?=$precoCompra?>">
            </div>
            <div class="form-group col-4">
                <label for="precoVenda">Preço Venda:</label>
                <input type="text" name="precoVenda" class="form-control" onKeyPress="return(moeda(this,'.',',',event))" placeholder="Digite o preço de Venda" value="<?=$precoVenda?>">
            </div>
            <div class="form-group col-4">

...
--
-- Host: 127.0.0.1
-- Generation Time: 23-Out-2018 às 21:44
...
(3, 'QUEIJO MUSSARELA', 140, 28, 0.28, 100, 1),
...
(9, 'Yokitos 120 Mg queijo', 1, 3, 2, 110, NULL),
...
(14, 'Pão Frances Ensopado', 3, 4.5, 2, 10, NULL);
...
INSERT INTO `usuario` (`id`, `nome`, `senha`, `status`, `tipoUsuario`, `cpf`, `endereco`, `telefone`, `rg`, `login`, `email`) VALUES
...
(3, 'Andréia Arida', '$2y$10$mGeL9O7EHYD/xRtNY7JVF.sPYnv1uEja5.Wpix4n/4eu/bbsToTB2', '1', 3, NULL, NULL, NULL, NULL, 'midorii', 'andreia@mido2ri.com'),
(5, 'Comprador Genérico', '$2y$10$24p9E0i4UeF4.ltoFU8cc.BUsFFT6PvzCFGjQeNUmiwhR/zhj.DBe', '1', 3, NULL, NULL, NULL, NULL, 'comprador1', 'compra@dor.com'),
(6, 'Robs', '$2y$10$f7e3oitnfRuA/5sBXzbQxu.nIH1VzzYnRXpcat/pScZbDaSuIE6mq', '1', 2, NULL, NULL, NULL, NULL, 'ojsfjdpos', 'dspofkdpofk@sdsd.com'),
(7, 'Edu Falaschi', '$2y$10$MND9VpVA.Og2SKTS5o8rq.I7jbiJy41.pz1RYnpRVXiAaoltNaq7O', '1', 2, NULL, NULL, NULL, NULL, 'carryon', 'suporte@angra.com'),
(8, 'Giovanni Bússola', '$2y$10$ayMf.cuWuMUQEpEdejEpq.nYhHKhswPjZ4u8YCwYq49546a8pnsK.', '1', 1, NULL, NULL, NULL, NULL, 'giovanni', 'sdsds@ds.com'),
(9, 'Luiz Paulo Mariano Pereira', '$2y$10$mUVwGXpoG3YCYfpqJP6eSepPUYQri.j9MPAbv9KFyz1fB7AYNqN.m', '1', 1, NULL, NULL, NULL, NULL, 'paulinho', 'paulo@gazin.com.br');

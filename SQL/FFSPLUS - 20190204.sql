...
--
-- Host: 127.0.0.1
-- Generation Time: 04-Fev-2019 às 21:01
...
INSERT INTO `pedido` (`id`, `usuario_id`, `produto_id`, `tamanho_id`, `andamento_id`) VALUES
(1, 16, 16, 1, 2),
(2, 21, 15, 2, 2),
(3, 20, 15, 1, 2);
...
--
ALTER TABLE `pedido_andamento`
  ADD CONSTRAINT `pedido_andamento_ibfk_1` FOREIGN KEY (`idPedido`) REFERENCES `pedido` (`id`),
  ADD CONSTRAINT `pedido_andamento_ibfk_2` FOREIGN KEY (`idAndamento`) REFERENCES `andamento` (`id`);

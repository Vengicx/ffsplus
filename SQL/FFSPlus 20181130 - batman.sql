...
--
-- Host: 127.0.0.1
-- Generation Time: 30-Nov-2018 às 20:19
...
(5, 'Teste Plus', 20, 20.5, 2, 10, 0),
(6, 'Mussarela Premium Gold', 10, 50, 0.05, 1000, 0);
...
INSERT INTO `pedido` (`id`, `usuario_id`, `produto_id`, `tamanho_id`, `andamento_id`, `horaPedido`) VALUES
(1, 11, 8, 1, 3, '2018-11-27 08:51:14'),
(2, 19, 8, 5, 3, '2018-11-27 13:39:03'),
(3, 15, 8, 5, 3, '2018-11-27 17:22:26'),
(4, 16, 8, 9, 3, '2018-11-27 17:23:16'),
(5, 11, 8, 5, 3, '2018-11-29 08:52:58');
...
(25, 'batman', '$2y$10$JvOA8XmvOOmHCP3KBg.yZeyRxcqrUQGznAHD4jzEZ2nDvN1e6t8QG', '1', 1, NULL, NULL, NULL, NULL, 'batman', 'bat@man.com', 0, NULL, NULL, NULL, NULL);
...
ALTER TABLE `pedido`
  ...
  ADD KEY `andamento_id` (`andamento_id`);
...
ALTER TABLE `pedido`
  ...
  ADD CONSTRAINT `pedido_ibfk_4` FOREIGN KEY (`andamento_id`) REFERENCES `andamento` (`id`);
